class ApplicationController < ActionController::Base
  ...
  private
    ...
    def query(definition, variables = {})
      response = RadioFranceScan::Client.query(definition, variables: variables, context: client_context)
    ...
    def client_context
      ...
      { access_token: RadioFranceScan::Application.secrets.radio_france_access_token }
    end
end
